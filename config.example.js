...
export const CONFIG = {
  ...
  systemPrompt: "",
  // Сколько шагов (обращений к модели) агент делает подряд, прежде чем сжать контекст.
  maxSteps: 12,
  // Сколько раз подряд можно сжимать контекст в одном запуске. 0 — не сжимать, а останавливаться.
  maxCompressions: 5,
};
